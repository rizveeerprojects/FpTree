...
public class FpTree {
    ...
    public static void main(String[] args) {
       ...
       double minimumSupport = Math.ceil((30/100.0)*database.transactions.size());
       ...
       for(int i=headerTable2.headerTable.size()-1;i>=0;i--){
         ...
         copy.patternMining(copy,headerTable2.headerTable.get(i).link,"",headerTable2,minimumSupportCount,generatedPatterns);
    ...
    void patternMining(FpTree tree,ArrayList<FpTree>lastNodes,String made,HeaderTable h,int minSupCnt,ArrayList<PatternInformation>generatedPatterns){
        ...
        if(singlePath==true){
           ...
           genereatePatternsFromSingleBranch(prefixTree,takenItems,takenItemsFreq,madeAlready,count,generatedPatterns,minSupCnt);
            ...
            for(int i=0;i<headertablePrefixTree.headerTable.size();i++){
               patternMining(prefixTree,headertablePrefixTree.headerTable.get(i).link,madeAlready,headertablePrefixTree,minSupCnt,generatedPatterns);
            }
        }
